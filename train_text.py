...
if DATASET_NAME == 'MIMIC':
    ...
    BATCH_SIZE = 32 if PHASE == 'TRAIN' else 16 # Fit 1 GPU
    MILESTONES = [10] # Reduce LR by 10 after reaching milestone epochs
...
if __name__ == "__main__":
    ...
    if PHASE == 'TRAIN':
        ...
        for epoch in range(last_epoch+1, EPOCHS):
            ...
            loss_dict['train'].append(val_loss)
            ...
            eval_dict['val'].append(val_metric)
    ...
    loss_df.to_csv('train_text_loss.csv', index=False)
    eval_df = pd.DataFrame(eval_dict)
    eval_df.to_csv('train_text_metric.csv', index=False)
